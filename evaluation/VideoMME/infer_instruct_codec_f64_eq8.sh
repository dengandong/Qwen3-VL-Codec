...
# Guidance profile: max_frames=64, equivalent 8-frame token budget.
...
python run_videomme.py infer \
    ...
    --duration short \
    --output-file "results/videomme_short_codec_f64_eq8_${CODEC_GUIDED_MODE}.jsonl" \
